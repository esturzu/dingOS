...
public:
    ...
    /**
     * Reads a complete block from the SD card.
     * Maps the filesystem block number to SD card sectors and reads them.
     * 
     ...
     * Handles both full and partial block writes (using read-modify-write).
     * 
