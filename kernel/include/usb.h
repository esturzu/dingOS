...
// Virtual base address of the DWC_OTG USB controller on RPi 3B (mapped by VMM)
#define USB_BASE 0xFFFF00003F980000
...
// Host Channel registers (per channel, offsets from HC0_BASE + channel * 0x20)
